...
static int start1=0,end1=0;
	...
	public N1(String str_name,int start,int end)
	{
		super();
...
{	if(initial_check_var==0)
	...
	*/
	...
	if(match_check_var==1)
	{
		...
		if(i_left3<=i_left)
		{
		i_left3=shift_left(text1,pattern3,(i_left3 + good_suffix_position),end1,(n21-1));
		count3=search_sub(text1,pattern3,i_left3,(n21-1),k,count3);
		match_check_var=0;
		i_left3++;
		}
	...
	{	
		if(i_left1<=i_left)
		{
		i_left1=shift_left(text1,pattern1,(i_left1 + bad_character_position),end1,(n21-1));
		count1=search_sub(text1,pattern1,i_left1,(n21-1),k,count1);
		i_left1++;
		}
		...
		if(i_left2<=i_left)
		{
		i_left2=shift_left(text1,pattern2,(i_left2 + bad_character_position),end1,(n21-1));
		count2=search_sub(text1,pattern2,i_left2,(n21-1),k,count2);
		i_left2++;
		}
		bad_character_position=0;
		if(i_left3<=i_left)
		{
		i_left3=shift_left(text1,pattern3,(i_left3 + bad_character_position),end1,(n21-1));
		count3=search_sub(text1,pattern3,i_left3,(n21-1),k,count3);
		i_left3++;
		}
		bad_character_position=0;
		if(i_left4<=i_left)
		{
		i_left4=shift_left(text1,pattern4,(i_left4 + bad_character_position),end1,(n21-1));
		count4=search_sub(text1,pattern4,i_left4,(n21-1),k,count4);
		i_left4++;
		}
		bad_character_position=0;
