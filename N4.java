...
/**
 * Summary description for N4
 *
 */
public class N4 extends JFrame implements ItemListener
{
...
static int start1=0,end1=0;
	...
	public N4(String str_name,int start,int end)
	{
		super();
...
FileWriter fw3 = new FileWriter("timeelapsed-IV.txt");
...
send.addActionListener(new ActionListener()
		{
			...
			{
				try{
		Socket cs=new Socket("localhost",3023);
		BufferedReader dis=new BufferedReader(new FileReader("timeelapsed-IV.txt"));
...
public static int shift_left(char[] text,char[] patt,int i_left,int n,int j)
{

 //System.out.println("In shift left\t"+i_left);

while(  ( text[i_left] != patt[j] ) && ( i_left< n1-1  ) )
i_left++;
