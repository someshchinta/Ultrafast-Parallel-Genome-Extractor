...
/**
 * Summary description for Backward_Sequential
 *
 */
public class Backward_Sequential extends JFrame implements ItemListener
{
...
static int i_right1=0;
static int i_right2=0;
static int i_right3=0;
static int i_right4=0;
static int i_right5=0;
static int i_right6=0;
static int i_right7=0;
static int i_right8=0;
static int i_right9=0;
static int i_right10=0;
...
static int[] badchar2=new int[110];
	...
	public Backward_Sequential(String str_name,int start,int end)
	{
		super();
...

{
	...
	private void initializeComponent()
	{
		...
		// title
		//
		title.setText("2^0 backward sequential algorithm");
		//
		// Tab
		//
		Tab.addTab("multiple pattern 2^0 backward sequential algorithm", Node1);
...
//
		...
		// N1
		//
		this.setTitle("multiple pattern 2^0 backward sequential algorithm");
...
{	if(initial_check_var==0)
	{
 	...
 	i_right1 = shift_right(text1,pattern1,i_right1-1,end1,(n21-1));
 
	count1=search_sub(text1,pattern1,i_right1,(n21-1),k,count1);
	
	i_right2 = shift_right(text1,pattern2,i_right2-1,end1,(n21-1));
	count2=search_sub(text1,pattern2,i_right2,(n21-1),k,count2);

	i_right3 = shift_right(text1,pattern3,i_right3-1,end1,(n21-1));
	count3=search_sub(text1,pattern3,i_right3,(n21-1),k,count3);

	i_right4 = shift_right(text1,pattern4,i_right4-1,end1,(n21-1));
	count4=search_sub(text1,pattern4,i_right4,(n21-1),k,count4);
	...
	if(match_check_var==1)
	{
		...
		if(i_right1>=i_right)
		{
		i_right1=shift_right(text1,pattern1,(i_right1 - good_suffix_position),end1,(n21-1));
		count1=search_sub(text1,pattern1,i_right1,(n21-1),k,count1);
		match_check_var=0;
		i_right1--;
		}
		...
		if(i_right3>=i_right)
		{
		i_right3=shift_right(text1,pattern3,(i_right3 - good_suffix_position),end1,(n21-1));
		count3=search_sub(text1,pattern3,i_right3,(n21-1),k,count3);
		match_check_var=0;
		i_right3--;
		}
		...
		if(i_right4<=i_right)
		{
		i_right4=shift_right(text1,pattern4,(i_right4 - good_suffix_position),end1,(n21-1));
		count4=search_sub(text1,pattern4,i_right4,(n21-1),k,count4);
		match_check_var=0;
		i_right4--;
		}
...
{	if(initial_check_var==0)
	{
 	...
 	i_right5 = shift_right(text1,pattern5,i_right5-1,end1,(n21-1));
 	count5=search_sub(text1,pattern5,i_right5,(n21-1),k,count5);
	
	i_right6 = shift_right(text1,pattern6,i_right6-1,end1,(n21-1));
	count6=search_sub(text1,pattern6,i_right6,(n21-1),k,count6);

	i_right7 = shift_right(text1,pattern7,i_right7-1,end1,(n21-1));
	count7=search_sub(text1,pattern7,i_right7,(n21-1),k,count7);

	i_right8 = shift_right(text1,pattern8,i_right8-1,end1,(n21-1));
	count8=search_sub(text1,pattern8,i_right8,(n21-1),k,count8);
	...
	if(match_check_var==1)
	{
		...
		if(i_right5>=i_right)
		{
		i_right5=shift_right(text1,pattern5,(i_right5 - good_suffix_position),end1,(n21-1));
		count5=search_sub(text1,pattern5,i_right5,(n21-1),k,count5);
		match_check_var=0;
		i_right5--;
		}
		...
		if(i_right6>=i_right)
		{
		i_right6=shift_right(text1,pattern6,(i_right6 - good_suffix_position),end1,(n21-1));
		count6=search_sub(text1,pattern6,i_right6,(n21-1),k,count6);
		match_check_var=0;
		i_right6--;
		}
		...
		if(i_right7>=i_right)
		{
		i_right7=shift_right(text1,pattern7,(i_right7 - good_suffix_position),end1,(n21-1));
		count7=search_sub(text1,pattern7,i_right7,(n21-1),k,count7);
		match_check_var=0;
		i_right7--;
		}
		...
		if(i_right8<=i_right)
		{
		i_right8=shift_right(text1,pattern8,(i_right8 - good_suffix_position),end1,(n21-1));
		count8=search_sub(text1,pattern8,i_right8,(n21-1),k,count8);
		match_check_var=0;
		i_right8--;
		}
	...
	{	
		...
		{
		i_right5=shift_right(text1,pattern5,(i_right5 - bad_character_position),end1,(n21-1));
		count5=search_sub(text1,pattern5,i_right5,(n21-1),k,count5);
		i_right5--;
		}
		...
		{
		i_right6=shift_right(text1,pattern6,(i_right6 - bad_character_position),end1,(n21-1));
		count6=search_sub(text1,pattern6,i_right6,(n21-1),k,count6);
		i_right6--;
		}
		...
		{
		i_right7=shift_right(text1,pattern7,(i_right7 - bad_character_position),end1,(n21-1));
		count7=search_sub(text1,pattern7,i_right7,(n21-1),k,count7);
		i_right7--;
		}
		...
		{
		i_right8=shift_right(text1,pattern8,(i_right8 - bad_character_position),end1,(n21-1));
		count8=search_sub(text1,pattern8,i_right8,(n21-1),k,count8);
		i_right8--;
		}
...
{	if(initial_check_var==0)
	{
 	...
 	i_right9 = shift_right(text1,pattern9,i_right9-1,end1,(n21-1));
 	count9=search_sub(text1,pattern9,i_right9,(n21-1),k,count9);
	...
	if(match_check_var==1)
	{
		...
		i_right9=shift_right(text1,pattern9,(i_right9 - good_suffix_position),end1,(n21-1));
		count9=search_sub(text1,pattern9,i_right9,(n21-1),k,count9);
		match_check_var=0;
		i_right9--;
		}
	...
	{	
		...
		{
		i_right9=shift_right(text1,pattern9,(i_right9 - bad_character_position),end1,(n21-1));
		count9=search_sub(text1,pattern9,i_right9,(n21-1),k,count9);
		i_right9--;
		}
...
{	if(initial_check_var==0)
	{
 	...
 	i_right10 = shift_right(text1,pattern10,i_right10-1,end1,(n21-1));
 	count10=search_sub(text1,pattern10,i_right10,(n21-1),k,count10);
	...
	if(match_check_var==1)
	{
		...
		if(i_right10>=i_right)
		{
		i_right10=shift_right(text1,pattern10,(i_right10 - good_suffix_position),end1,(n21-1));
		count10=search_sub(text1,pattern10,i_right10,(n21-1),k,count10);
		match_check_var=0;
		i_right10--;
		}
	...
	{	
		...
		{
		i_right10=shift_right(text1,pattern10,(i_right10 - bad_character_position),end1,(n21-1));
		count10=search_sub(text1,pattern10,i_right10,(n21-1),k,count10);
		i_right10--;
		}
...
while ( j1 >=0 && ( text[i_right-k[comp_pos]] == patt[j-k[comp_pos]] ) )
{
j1--;  
comp_pos ++;
}
...
{
if(i_right<end1)bad_character_position= max(1, j - badchar10[text[i_right-j]]);
